...
@Component({
  selector: 'app-derive-laboratory',
  templateUrl: './derive-laboratory.component.html',
  styleUrls: ['./derive-laboratory.component.css']
})
export class DeriveLaboratoryComponent implements OnInit {
  ...
  onSubmit(formPatient) {
    this.msh.receivingApplication = "LIS";
    ...
    this.ApiService.createOML_O21(this.msg);
