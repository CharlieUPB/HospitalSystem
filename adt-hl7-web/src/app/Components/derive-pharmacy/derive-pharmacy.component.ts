...
@Component({
  selector: 'app-derive-pharmacy',
  templateUrl: './derive-pharmacy.component.html',
  styleUrls: ['./derive-pharmacy.component.css']
})
export class DerivePharmacyComponent implements OnInit {
  ...
  msg :  GenericMessage={Msh: null,In1: null,Obr: null,Obx: null,Orc: null,Pid: null,Pv1: null, Evn: "O11"};
  ...
  onSubmit(formPatient) {
    this.msh.receivingApplication = "PHARMACY";
    ...
    this.ApiService.createRDE_O11(this.msg);
